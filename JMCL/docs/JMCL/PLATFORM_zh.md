  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <br>
        🕰️ <a href="https://github.com/Open-code-Studio/JMCL/releases">JMCL 2026.1</a> (Windows Vista)
        <br>
        🕰️ <a href="https://github.com/Open-code-Studio/JMCL/releases">JMCL 2026.1</a> (Windows Server 2003 ~ 2008) 
      </td>
      <td>✅️ 完整支持</td>
      <td>✅️ 完整支持</td>
      <td>✅ 完整支持</td>
    ...
    <tr>
      ...
      <td>
        ...
        <br>
        🕰️ <a href="https://github.com/Open-code-Studio/JMCL/releases">JMCL 2026.1</a> (Windows XP/Vista)
      </td>
      <td>🕰️ 有限支持</td>
      <td>/</td>
      <td>/</td>
...
* ✅️ 完整支持
  ...
  受到完整支持的平台。JMCL 会尽可能为此平台提供支持。

* 🕰️ 有限支持

  这些平台通常是老旧的遗留平台。

  JMCL 可以在这些平台上工作，但部分功能可能无法使用。
...
* 👌: 支持的平台
  ...
  由 JMCL 提供支持，经过测试可以正常运行，但可能比得到全面支持的平台有更多问题。  
  不保证支持 Minecraft 1.6 以下的版本。  
  如果你遇到在得到全面支持的平台上不存在的问题，可以向 JMCL 反馈。

* ❔: 低级别支持的平台

  JMCL 可以在这个平台上运行，并且有一些基本的支持。但是，还不能正常地启动游戏。  
