...
如果你想要了解 JMCL 对不同平台的支持程度，请参见 [此表格](../../page/index.html#/PLATFORM_zh)。
...
在参与贡献前，请阅读[贡献指南](../../page/index.html#/Contributing_zh)，其中包含以下内容：

- [如何从源码构建并运行 JMCL](../../page/index.html#/Contributing_zh)
- [通过调试选项调整 JMCL 的行为](../../page/index.html#/Contributing_zh)
